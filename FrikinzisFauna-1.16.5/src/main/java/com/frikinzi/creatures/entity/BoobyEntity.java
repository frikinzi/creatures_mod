...
public class BoobyEntity extends NonTameableFlyingBirdBase implements IAnimatable {
    ...
    private static final DataParameter<Boolean> DISPLAYING = EntityDataManager.defineId(BoobyEntity.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> ON_DISPLAY = EntityDataManager.defineId(BoobyEntity.class, DataSerializers.BOOLEAN);
    ...
    public static final Map<Integer, TranslationTextComponent> SPECIES_NAMES = ImmutableMap.<Integer, TranslationTextComponent>builder()
            .put(1, new TranslationTextComponent("message.creatures.northerngannet"))
            .put(2, new TranslationTextComponent("message.creatures.australasiangannet"))
            .put(3, new TranslationTextComponent("message.creatures.capegannet"))
            .put(4, new TranslationTextComponent("message.creatures.redfootedbooby"))
            .put(5, new TranslationTextComponent("message.creatures.nazcabooby"))
            .put(6, new TranslationTextComponent("message.creatures.maskedbooby"))
            .put(7, new TranslationTextComponent("message.creatures.brownbooby"))
            .put(8, new TranslationTextComponent("message.creatures.abbottsbooby"))
            .put(9, new TranslationTextComponent("message.creatures.bluefootedbooby"))
            .put(10, new TranslationTextComponent("message.creatures.peruvianbooby"))
            .put(11, new TranslationTextComponent("message.creatures.brownbooby"))
            .build();
    ...
    public BoobyEntity(EntityType<? extends BoobyEntity> p_i50251_1_, World p_i50251_2_) {
    ...
    protected void registerGoals() {
        super.registerGoals();
        if (!this.isBaby()) {
            this.goalSelector.addGoal(1, new BoobyEntity.DisplayGoal());
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        BoobyEntity boobyentity = (BoobyEntity) getType().create(p_241840_1_);
    ...
    protected SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.BOOBY; } else {
            return null;
        }
    }
    ...
    public class DisplayGoal extends Goal {
        private final EntityPredicate predicate = (new EntityPredicate()).range(16.0D).allowInvulnerable().selector((p_220844_0_) -> {
            return ((BoobyEntity)p_220844_0_).getGender() == 0 && !((BoobyEntity)p_220844_0_).isBaby();
        });
        ...
        public boolean canUse() {
            if (!BoobyEntity.this.isOnGround()) {
                return false;
            }
            if (BoobyEntity.this.getVariant() != 9) {
                return false;
            }
            if (BoobyEntity.this.getGender() == 0 || BoobyEntity.this.isSleeping() || BoobyEntity.this.isBaby()) {
                return false;
            } else {
                List<BoobyEntity> list = BoobyEntity.this.level.getNearbyEntities(BoobyEntity.class, this.predicate, BoobyEntity.this, BoobyEntity.this.getBoundingBox().inflate(16.0D, 4.0D, 16.0D));
                if (list.isEmpty()) {
                    return false;
                } else {
                    return true;
        ...
        public boolean canContinueToUse() {
            List<BoobyEntity> list = BoobyEntity.this.level.getNearbyEntities(BoobyEntity.class, this.predicate, BoobyEntity.this, BoobyEntity.this.getBoundingBox().inflate(16.0D, 4.0D, 16.0D));
            return !(list.isEmpty() || BoobyEntity.this.isSleeping() || BoobyEntity.this.isInSittingPose() || BoobyEntity.this.isBaby());
        }
    ...
    public float getHatchChance() {
        return Double.valueOf(CreaturesConfig.booby_hatch_chance.get()).floatValue();
    }
