...
public class LittlePenguinEntity extends NonTameableBirdBase implements IAnimatable {
    private final GroundPathNavigator groundNavigation;
    protected final SwimmerPathNavigator waterNavigation;
    private boolean searchingForLand;
    private static final DataParameter<Integer> VARIANT_SUBID = EntityDataManager.defineId(LittlePenguinEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.defineId(LittlePenguinEntity.class, DataSerializers.BLOCK_POS);
    private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.defineId(LittlePenguinEntity.class, DataSerializers.BOOLEAN);
    ...
    static {
        ...
        messageMap.put(1, new TranslationTextComponent("message.creatures.bluepenguin"));
        messageMap.put(2, new TranslationTextComponent("message.creatures.australianlittle"));
    ...
    public LittlePenguinEntity(EntityType<? extends LittlePenguinEntity> p_i50251_1_, World p_i50251_2_) {
        super(p_i50251_1_, p_i50251_2_);
        this.setPathfindingMalus(PathNodeType.WATER, 0.0F);
        this.moveControl = new LittlePenguinEntity.MoveHelperController(this);
        this.maxUpStep = 1.0F;
   ...
   protected PathNavigator createNavigation(World p_175447_1_) {
       return new LittlePenguinEntity.Navigator(this, p_175447_1_);
   }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(7, new LittlePenguinEntity.TravelGoal(this, 1.0D));
        this.goalSelector.addGoal(9, new LittlePenguinEntity.WanderGoal(this, 1.0D, 100));
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        LittlePenguinEntity crestedpenguin = (LittlePenguinEntity) getType().create(p_241840_1_);
    ...
    protected SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.LITTLE_PENGUIN; } else {
            return null;
        }
    }
...
//            }
    ...
    static class MoveHelperController extends MovementController {
        private final LittlePenguinEntity penguin;

        MoveHelperController(LittlePenguinEntity p_i48817_1_) {
            super(p_i48817_1_);
...
//
 //           }
    ...
    static class Navigator extends SwimmerPathNavigator {
        Navigator(LittlePenguinEntity p_i48815_1_, World p_i48815_2_) {
        ...
        public boolean isStableDestination(BlockPos p_188555_1_) {
            if (this.mob instanceof LittlePenguinEntity) {
                LittlePenguinEntity cormorant = (LittlePenguinEntity)this.mob;
    ...
    static class TravelGoal extends Goal {
        private final LittlePenguinEntity cormorant;
        private final double speedModifier;
        private boolean stuck;

        TravelGoal(LittlePenguinEntity p_i48811_1_, double p_i48811_2_) {
    ...
    static class WanderGoal extends RandomWalkingGoal {
        ...
        private WanderGoal(LittlePenguinEntity p_i48813_1_, double p_i48813_2_, int p_i48813_4_) {
    ...
    static class GoToBeachGoal extends MoveToBlockGoal {
        private final LittlePenguinEntity drowned;

        public GoToBeachGoal(LittlePenguinEntity p_i48911_1_, double p_i48911_2_) {
    ...
    static class SwimUpGoal extends Goal {
        ...
        public SwimUpGoal(LittlePenguinEntity p_i48908_1_, double p_i48908_2_, int p_i48908_4_) {
    ...
    public ITextComponent getFunFact() {
        return new TranslationTextComponent("description.creatures.littlepenguin");
    }
