...
public class LookdownEntity extends GroupFishBase implements IAnimatable {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(LookdownEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    public LookdownEntity(EntityType<? extends LookdownEntity> p_i50246_1_, World p_i50246_2_) {
        super(p_i50246_1_, p_i50246_2_);
    }
    public static Map<Integer, TranslationTextComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslationTextComponent("message.creatures.lookdowndark"),
            2, new TranslationTextComponent("message.creatures.lookdownsilver")
    );
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(CreaturesItems.LOOKDOWN_BUCKET);
    }
