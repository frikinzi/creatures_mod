...
public class BrushTailedPenguinEntity extends NonTameableBirdBase implements IAnimatable {
    ...
    private static final DataParameter<Integer> VARIANT_SUBID = EntityDataManager.defineId(BrushTailedPenguinEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.defineId(BrushTailedPenguinEntity.class, DataSerializers.BLOCK_POS);
    private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.defineId(BrushTailedPenguinEntity.class, DataSerializers.BOOLEAN);
    ...
    public static Map<Integer, TranslationTextComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslationTextComponent("message.creatures.chinstrap"),
            2, new TranslationTextComponent("message.creatures.gentoo"),
            3, new TranslationTextComponent("message.creatures.adelie")
    );
    public static Map<Integer, TranslationTextComponent> DESCRIPTIONS = ImmutableMap.of(
            1, new TranslationTextComponent("description.creatures.chinstrap"),
            2, new TranslationTextComponent("description.creatures.gentoo"),
            3, new TranslationTextComponent("description.creatures.adelie")
    );
    ...
    public BrushTailedPenguinEntity(EntityType<? extends BrushTailedPenguinEntity> p_i50251_1_, World p_i50251_2_) {
        super(p_i50251_1_, p_i50251_2_);
        this.setPathfindingMalus(PathNodeType.WATER, 0.0F);
        this.moveControl = new BrushTailedPenguinEntity.MoveHelperController(this);
        this.maxUpStep = 1.0F;
   ...
   protected PathNavigator createNavigation(World p_175447_1_) {
       return new BrushTailedPenguinEntity.Navigator(this, p_175447_1_);
   }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        BrushTailedPenguinEntity cormorantentity = (BrushTailedPenguinEntity) getType().create(p_241840_1_);
    ...
    protected SoundEvent getAmbientSound() {
        ...
        return CreaturesSound.BRUSHTAILED_PENGUIN; } else {
            return null;
        }
    }
    ...
    public CreaturesEggEntity layEgg(CreaturesBirdEntity animal) {
        ...
        if (this.random.nextInt(CreaturesConfig.penguin_mutation_chance.get()) == 1) {
            egg.setSubVariant(this.random.nextInt(BANDEDPENGUIN.get(this.getVariant()))+1);
        } else {
    ...
    public int getSubVariant() {
        return MathHelper.clamp(this.entityData.get(VARIANT_SUBID), 1, BANDEDPENGUIN.get(this.getVariant())+1);
    }
    ...
    static class MoveHelperController extends MovementController {
        private final BrushTailedPenguinEntity penguin;

        MoveHelperController(BrushTailedPenguinEntity p_i48817_1_) {
            super(p_i48817_1_);
    ...
    static class Navigator extends SwimmerPathNavigator {
        Navigator(BrushTailedPenguinEntity p_i48815_1_, World p_i48815_2_) {
        ...
        public boolean isStableDestination(BlockPos p_188555_1_) {
            if (this.mob instanceof BrushTailedPenguinEntity) {
                BrushTailedPenguinEntity cormorant = (BrushTailedPenguinEntity)this.mob;
    ...
    static class TravelGoal extends Goal {
        private final BrushTailedPenguinEntity cormorant;
        private final double speedModifier;
        private boolean stuck;

        TravelGoal(BrushTailedPenguinEntity p_i48811_1_, double p_i48811_2_) {
    ...
    static class WanderGoal extends RandomWalkingGoal {
        ...
        private WanderGoal(BrushTailedPenguinEntity p_i48813_1_, double p_i48813_2_, int p_i48813_4_) {
    ...
    static class GoToBeachGoal extends MoveToBlockGoal {
        private final BrushTailedPenguinEntity drowned;

        public GoToBeachGoal(BrushTailedPenguinEntity p_i48911_1_, double p_i48911_2_) {
    ...
    static class SwimUpGoal extends Goal {
        ...
        public SwimUpGoal(BrushTailedPenguinEntity p_i48908_1_, double p_i48908_2_, int p_i48908_4_) {
