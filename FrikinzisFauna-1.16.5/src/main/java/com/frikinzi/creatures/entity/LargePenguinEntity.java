...
public class LargePenguinEntity extends NonTameableBirdBase implements IAnimatable {
    ...
    private static final DataParameter<Integer> VARIANT_SUBID = EntityDataManager.defineId(LargePenguinEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.defineId(LargePenguinEntity.class, DataSerializers.BLOCK_POS);
    private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.defineId(LargePenguinEntity.class, DataSerializers.BOOLEAN);
    ...
    public static Map<Integer, TranslationTextComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslationTextComponent("message.creatures.emperorpenguin"),
            2, new TranslationTextComponent("message.creatures.kingpenguin")
    );
    public static Map<Integer, TranslationTextComponent> DESCRIPTIONS = ImmutableMap.of(
            1, new TranslationTextComponent("description.creatures.emperorpenguin"),
            2, new TranslationTextComponent("description.creatures.kingpenguin")
    );
    ...
    public LargePenguinEntity(EntityType<? extends LargePenguinEntity> p_i50251_1_, World p_i50251_2_) {
        super(p_i50251_1_, p_i50251_2_);
        this.setPathfindingMalus(PathNodeType.WATER, 0.0F);
        this.moveControl = new LargePenguinEntity.MoveHelperController(this);
        this.maxUpStep = 1.0F;
   ...
   protected PathNavigator createNavigation(World p_175447_1_) {
       return new LargePenguinEntity.Navigator(this, p_175447_1_);
   }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(7, new LargePenguinEntity.TravelGoal(this, 1.0D));
        this.goalSelector.addGoal(9, new LargePenguinEntity.WanderGoal(this, 1.0D, 100));
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        LargePenguinEntity largepenguin = (LargePenguinEntity) getType().create(p_241840_1_);
        largepenguin.setVariant(this.getVariant());
        largepenguin.setGender(this.random.nextInt(2));
        largepenguin.setHeightMultiplier(getSpawnEggOffspringHeight());
        return largepenguin;
    }
    ...
    protected SoundEvent getAmbientSound() {
        ...
        return CreaturesSound.LARGE_PENGUIN; } else {
    ...
    public int getSubVariant() {
        return MathHelper.clamp(this.entityData.get(VARIANT_SUBID), 1, 1);
    }
    ...
    static class MoveHelperController extends MovementController {
        private final LargePenguinEntity penguin;

        MoveHelperController(LargePenguinEntity p_i48817_1_) {
            super(p_i48817_1_);
    ...
    static class Navigator extends SwimmerPathNavigator {
        Navigator(LargePenguinEntity p_i48815_1_, World p_i48815_2_) {
        ...
        public boolean isStableDestination(BlockPos p_188555_1_) {
            if (this.mob instanceof LargePenguinEntity) {
                LargePenguinEntity cormorant = (LargePenguinEntity)this.mob;
    ...
    static class TravelGoal extends Goal {
        private final LargePenguinEntity cormorant;
        private final double speedModifier;
        private boolean stuck;

        TravelGoal(LargePenguinEntity p_i48811_1_, double p_i48811_2_) {
    ...
    static class WanderGoal extends RandomWalkingGoal {
        ...
        private WanderGoal(LargePenguinEntity p_i48813_1_, double p_i48813_2_, int p_i48813_4_) {
    ...
    static class GoToBeachGoal extends MoveToBlockGoal {
        private final LargePenguinEntity drowned;

        public GoToBeachGoal(LargePenguinEntity p_i48911_1_, double p_i48911_2_) {
    ...
    static class SwimUpGoal extends Goal {
        ...
        public SwimUpGoal(LargePenguinEntity p_i48908_1_, double p_i48908_2_, int p_i48908_4_) {
    ...
    public int methodofDeterminingVariant(IWorld p_213610_1_) {
        int var = this.random.nextInt(2)+1;
        return var;
    }
    ...
    public boolean onIceBlock(CreatureEntity entity) {
    ...
    public static boolean checkPenguinSpawnRules(EntityType<? extends AnimalEntity> p_223316_0_, IWorld p_223316_1_, SpawnReason p_223316_2_, BlockPos p_223316_3_, Random p_223316_4_) {
        return p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.SAND) ||p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.ICE) ||p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.BLUE_ICE) ||p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.PACKED_ICE)||p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.FROSTED_ICE)||p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.SNOW_BLOCK) || p_223316_1_.getBlockState(p_223316_3_.below()).is(Blocks.GRASS_BLOCK) && p_223316_1_.getRawBrightness(p_223316_3_, 0) > 8;
    }
