...
public class YellowEyedPenguinEntity extends NonTameableBirdBase implements IAnimatable {
    ...
    private static final DataParameter<Integer> VARIANT_SUBID = EntityDataManager.defineId(YellowEyedPenguinEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.defineId(YellowEyedPenguinEntity.class, DataSerializers.BLOCK_POS);
    private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.defineId(YellowEyedPenguinEntity.class, DataSerializers.BOOLEAN);
    ...
    static {
        ...
        messageMap.put(1, new TranslationTextComponent("message.creatures.yelloweyedpenguin"));
    ...
    static {
        Map<Integer, TranslationTextComponent> messageMap = new HashMap<>();
        messageMap.put(1, new TranslationTextComponent("description.creatures.yelloweyedpenguin"));
        DESCRIPTION = Collections.unmodifiableMap(messageMap);
    }

    public YellowEyedPenguinEntity(EntityType<? extends YellowEyedPenguinEntity> p_i50251_1_, World p_i50251_2_) {
        super(p_i50251_1_, p_i50251_2_);
        this.setPathfindingMalus(PathNodeType.WATER, 0.0F);
        this.moveControl = new YellowEyedPenguinEntity.MoveHelperController(this);
        this.maxUpStep = 1.0F;
   ...
   protected PathNavigator createNavigation(World p_175447_1_) {
       return new YellowEyedPenguinEntity.Navigator(this, p_175447_1_);
   }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(7, new YellowEyedPenguinEntity.TravelGoal(this, 1.0D));
        this.goalSelector.addGoal(9, new YellowEyedPenguinEntity.WanderGoal(this, 1.0D, 100));
    ...
    public static AttributeModifierMap.MutableAttribute createAttributes() {
        return MobEntity.createMobAttributes().add(Attributes.MAX_HEALTH, 6.0D).add(Attributes.MOVEMENT_SPEED, (double)0.2F).add(Attributes.ATTACK_DAMAGE, 2.0D);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        YellowEyedPenguinEntity crestedpenguin = (YellowEyedPenguinEntity) getType().create(p_241840_1_);
    ...
    protected SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.YELLOWEYED_PENGUIN; } else {
            return null;
        }
    }
    ...
    static class MoveHelperController extends MovementController {
        ...
        MoveHelperController(YellowEyedPenguinEntity p_i48817_1_) {
            super(p_i48817_1_);
    ...
    static class Navigator extends SwimmerPathNavigator {
        Navigator(YellowEyedPenguinEntity p_i48815_1_, World p_i48815_2_) {
        ...
        public boolean isStableDestination(BlockPos p_188555_1_) {
            if (this.mob instanceof YellowEyedPenguinEntity) {
                YellowEyedPenguinEntity cormorant = (YellowEyedPenguinEntity)this.mob;
    ...
    static class TravelGoal extends Goal {
        ...
        TravelGoal(YellowEyedPenguinEntity p_i48811_1_, double p_i48811_2_) {
    ...
    static class WanderGoal extends RandomWalkingGoal {
        ...
        private WanderGoal(YellowEyedPenguinEntity p_i48813_1_, double p_i48813_2_, int p_i48813_4_) {
    ...
    static class GoToBeachGoal extends MoveToBlockGoal {
        ...
        public GoToBeachGoal(YellowEyedPenguinEntity p_i48911_1_, double p_i48911_2_) {
            super(p_i48911_1_, p_i48911_2_, 8, 2);
            this.penguin = p_i48911_1_;
        }

        public boolean canUse() {
            return super.canUse() && !this.penguin.level.isDay() && this.penguin.isInWater() && this.penguin.getY() >= (double)(this.penguin.level.getSeaLevel() - 3);
        }
        ...
        protected boolean isValidTarget(IWorldReader p_179488_1_, BlockPos p_179488_2_) {
            ...
            return p_179488_1_.isEmptyBlock(blockpos) && p_179488_1_.isEmptyBlock(blockpos.above()) ? p_179488_1_.getBlockState(p_179488_2_).entityCanStandOn(p_179488_1_, p_179488_2_, this.penguin) : false;
        }

        public void start() {
            this.penguin.setSearchingForLand(false);
            this.penguin.navigation = this.penguin.groundNavigation;
            super.start();
        }
    ...
    static class SwimUpGoal extends Goal {
        ...
        public SwimUpGoal(YellowEyedPenguinEntity p_i48908_1_, double p_i48908_2_, int p_i48908_4_) {
