...
public class BandedPenguinEntity extends NonTameableBirdBase implements IAnimatable {
    private final GroundPathNavigator groundNavigation;
    protected final SwimmerPathNavigator waterNavigation;
    private boolean searchingForLand;
    private static final DataParameter<Integer> VARIANT_SUBID = EntityDataManager.defineId(BandedPenguinEntity.class, DataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);
    private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.defineId(BandedPenguinEntity.class, DataSerializers.BLOCK_POS);
    private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.defineId(BandedPenguinEntity.class, DataSerializers.BOOLEAN);
    ...
    public static Map<Integer, TranslationTextComponent> SPECIES_NAMES = ImmutableMap.of(
            1, new TranslationTextComponent("message.creatures.humboldtpenguin"),
            2, new TranslationTextComponent("message.creatures.africanpenguin"),
            3, new TranslationTextComponent("message.creatures.magellanicpenguin"),
            4, new TranslationTextComponent("message.creatures.galapagospenguin")
    );
    public static Map<Integer, TranslationTextComponent> DESCRIPTIONS = ImmutableMap.of(
            1, new TranslationTextComponent("description.creatures.humboldtpenguin"),
            2, new TranslationTextComponent("description.creatures.africanpenguin"),
            3, new TranslationTextComponent("description.creatures.magellanicpenguin"),
            4, new TranslationTextComponent("description.creatures.galapagospenguin")
    );
    ...
    public BandedPenguinEntity(EntityType<? extends BandedPenguinEntity> p_i50251_1_, World p_i50251_2_) {
        super(p_i50251_1_, p_i50251_2_);
        this.setPathfindingMalus(PathNodeType.WATER, 0.0F);
        this.moveControl = new BandedPenguinEntity.MoveHelperController(this);
        this.maxUpStep = 1.0F;
   ...
   protected PathNavigator createNavigation(World p_175447_1_) {
       return new BandedPenguinEntity.Navigator(this, p_175447_1_);
   }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(7, new BandedPenguinEntity.TravelGoal(this, 1.0D));
        this.goalSelector.addGoal(9, new BandedPenguinEntity.WanderGoal(this, 1.0D, 100));
    ...
    public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        BandedPenguinEntity cormorantentity = (BandedPenguinEntity) getType().create(p_241840_1_);
    ...
    protected SoundEvent getAmbientSound() {
        if (!this.isSleeping()) {
        return CreaturesSound.BANDEDPENGUIN; } else {
            return null;
        }
    }
    ...
    public int getSubVariant() {
        return MathHelper.clamp(this.entityData.get(VARIANT_SUBID), 1, BANDEDPENGUIN.get(this.getVariant()));
    }
    ...
    static class MoveHelperController extends MovementController {
        private final BandedPenguinEntity penguin;

        MoveHelperController(BandedPenguinEntity p_i48817_1_) {
            super(p_i48817_1_);
    ...
    static class Navigator extends SwimmerPathNavigator {
        Navigator(BandedPenguinEntity p_i48815_1_, World p_i48815_2_) {
        ...
        public boolean isStableDestination(BlockPos p_188555_1_) {
            if (this.mob instanceof BandedPenguinEntity) {
                BandedPenguinEntity cormorant = (BandedPenguinEntity)this.mob;
    ...
    static class TravelGoal extends Goal {
        private final BandedPenguinEntity cormorant;
        private final double speedModifier;
        private boolean stuck;

        TravelGoal(BandedPenguinEntity p_i48811_1_, double p_i48811_2_) {
    ...
    static class WanderGoal extends RandomWalkingGoal {
        ...
        private WanderGoal(BandedPenguinEntity p_i48813_1_, double p_i48813_2_, int p_i48813_4_) {
    ...
    static class GoToBeachGoal extends MoveToBlockGoal {
        private final BandedPenguinEntity drowned;

        public GoToBeachGoal(BandedPenguinEntity p_i48911_1_, double p_i48911_2_) {
    ...
    static class SwimUpGoal extends Goal {
        ...
        public SwimUpGoal(BandedPenguinEntity p_i48908_1_, double p_i48908_2_, int p_i48908_4_) {
