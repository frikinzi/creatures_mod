...
public class GooseEntity extends NonTameableFlyingBirdBase implements IAnimatable {
    ...
    public static final Map<Integer, TranslationTextComponent> DESCRIPTIONS = ImmutableMap.<Integer, TranslationTextComponent>builder()
            .put(1, new TranslationTextComponent("description.creatures.canada"))
            .put(2, new TranslationTextComponent("description.creatures.barnacle"))
            .put(3, new TranslationTextComponent("description.creatures.graylag"))
            .put(4, new TranslationTextComponent("description.creatures.snow"))
            .put(5, new TranslationTextComponent("description.creatures.orinoco"))
            .put(6, new TranslationTextComponent("description.creatures.barheaded"))
            .build();
