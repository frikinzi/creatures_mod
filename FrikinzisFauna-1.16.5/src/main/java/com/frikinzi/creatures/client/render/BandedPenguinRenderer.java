...
public class BandedPenguinRenderer extends GeoEntityRenderer<BandedPenguinEntity>{
    public BandedPenguinRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new BandedPenguinModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(BandedPenguinEntity animatable, MatrixStack stackIn, float ticks,
