...
public class PuffinRenderer extends GeoEntityRenderer<PuffinEntity> {
    public PuffinRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new PuffinModel());
        this.shadowRadius = 0.4F;
    }

    @Override
    public void renderEarly(PuffinEntity animatable, MatrixStack stackIn, float ticks,
