...
public class BarracudaRenderer extends GeoEntityRenderer<BarracudaEntity>{
    public BarracudaRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new BarracudaModel());
        this.shadowRadius = 0.3F;
    }

    @Override
    public void renderEarly(BarracudaEntity animatable, MatrixStack stackIn, float ticks,
